      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
            Welcome to <span className="text-orange-600">Prebucks</span>
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Mumbai's hyperlocal discount and loyalty platform. Earn Bucks at local businesses 
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <Card className="text-center">
            <CardHeader>
              ...
              <CardTitle>Prebucks Rewards</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription>
                Earn Prebucks with every purchase and spend them at any partner business.
              </CardDescription>
            </CardContent>
          </Card>
        ...
        <div className="text-center">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold mb-2">Earn Prebucks</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Use Bucks at any partner business in the network
              </p>
            </div>
          </div>
        </div>
